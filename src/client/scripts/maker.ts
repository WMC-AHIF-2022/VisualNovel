...
export class Maker {
  ...
  createScene() {
    ...
    if (
      this.curScene === null ||
      this.curScene.getId() === this.game.getScenes().length - 1
    ) {
    ...
    leftChar.addEventListener("change", async () => {
      ...
      document.getElementById("file-label").style.backgroundColor =
        "transparent";
    ...
    rightChar.addEventListener("change", async () => {
      ...
      document.getElementById("file-label2").style.backgroundColor =
        "transparent";
  ...
  saveSceneElements() {
    ...
    this.curScene.setTalkingCharacter(
      (<HTMLInputElement>document.getElementById("povName")).value
    );
    this.curScene.setText(
      (<HTMLInputElement>document.getElementById("playgroundTextbox")).value
    );
  ...
  createOptions() {
    let html =
      '<button id="btn1">Option 1</button><button id="btn2 ">Option 2</button>';
  ...
  private loadScene(scene: Scene) {
    ...
    console.log(scene);
    (<HTMLInputElement>document.getElementById("playgroundTextbox")).value =
      this.curScene.getText();
    (<HTMLInputElement>document.getElementById("povName")).value =
      this.curScene.getTalkingCharacter();
    document.getElementById("bgLabel").style.backgroundImage = this.curScene
      .getPictures()
      .getBackground();
